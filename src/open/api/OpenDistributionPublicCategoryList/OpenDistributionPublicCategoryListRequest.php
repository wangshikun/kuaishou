<?php
	...
	namespace ytk\open\api\OpenDistributionPublicCategoryList;
	
	use ytk\open\cored\GlobalConfig;
    use ytk\open\cored\KuaiShouOpClient;
    
	Class OpenDistributionPublicCategoryListRequest
	{ 
		private $param;
		...
		public function __construct()
	    {
		    ...
		    $this->param= new OpenDistributionPublicCategoryListParam();
