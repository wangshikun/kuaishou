<?php
	...
	namespace ytk\open\api\OpenServiceMarketBuyerServiceInfo;
	
	use ytk\open\cored\GlobalConfig;
    use ytk\open\cored\KuaiShouOpClient;
    
	Class OpenServiceMarketBuyerServiceInfoRequest
	{ 
		private $param;
		...
		public function __construct()
	    {
		    ...
		    $this->param= new OpenServiceMarketBuyerServiceInfoParam();
