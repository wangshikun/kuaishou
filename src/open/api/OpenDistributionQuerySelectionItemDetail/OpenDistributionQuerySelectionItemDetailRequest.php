<?php
	...
	namespace ytk\open\api\OpenDistributionQuerySelectionItemDetail;
	
	use ytk\open\cored\GlobalConfig;
    use ytk\open\cored\KuaiShouOpClient;
    
	Class OpenDistributionQuerySelectionItemDetailRequest
	{ 
		private $param;
		...
		public function __construct()
	    {
		    ...
		    $this->param= new OpenDistributionQuerySelectionItemDetailParam();
