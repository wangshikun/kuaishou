<?php
	...
	namespace ytk\open\api\OpenDistributionCpsLeaderOrderCursorList;
	
	use ytk\open\cored\GlobalConfig;
    use ytk\open\cored\KuaiShouOpClient;
    
	Class OpenDistributionCpsLeaderOrderCursorListRequest
	{ 
		private $param;
		...
		public function __construct()
	    {
		    ...
		    $this->param= new OpenDistributionCpsLeaderOrderCursorListParam();
